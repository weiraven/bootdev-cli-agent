...
def main():
    ...
    for _ in range(20):
        ...
        if response.function_calls:
            ...
            messages.append(types.Content(role="user", parts=function_responses)) # this is what gives the model access to the tool outputs on the next pass. Without it, no real agent loop.
